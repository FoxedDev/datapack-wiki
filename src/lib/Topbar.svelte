...
<div class="bg-stone-800 flex w-full items-center justify-between p-2 h-12 sticky top-0 border-b border-stone-700 z-20">
  ...
  <div class="flex items-center gap-2">
    ...
    <a
      ...
      class="bg-black/45 p-2 rounded-lg py-1 flex items-center gap-2 hover:text-stone-100 hover:bg-[#5865F2] aspect-square sm:aspect-auto focus-visible:outline-2 focus-visible:outline-dph-orange"
      aria-label="Discord">
      <IconDiscord />
