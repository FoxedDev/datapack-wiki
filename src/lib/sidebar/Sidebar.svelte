    ...
    {#if windowInfo.isNavOpen}
      ...
      <div class="flex items-center mb-2 gap-1">
        <button
          class="{page == 'wiki'
            ? 'bg-stone-700'
            : 'bg-stone-800'} cursor-pointer hover:bg-stone-600 hover:text-white hover:font-medium px-2 py-1 rounded-md flex items-center gap-1 focus-visible:outline-2 focus-visible:outline-dph-orange"
          onclick={() => {
            page = "wiki";
        ...
        <button
          class="{page == 'guides'
            ? 'bg-stone-700'
            : 'bg-stone-800'} cursor-pointer hover:bg-stone-700 hover:text-white hover:font-medium px-2 py-1 rounded-md flex items-center gap-1 focus-visible:outline-2 focus-visible:outline-dph-orange"
          onclick={() => {
            page = "guides";
